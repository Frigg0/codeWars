package com.company.kyu8.substractTheSum;
...
public class Kata {
    public static String subtractSum (int n) {
       return getMap().get(getSum(n));
    }

    private static int getSum(int n){
        int m = n - String.valueOf(n).chars().map(Character::getNumericValue).sum();
...
/*
Substracting the sum will always return a result divisible by 9
return "apple";
is enough
 */